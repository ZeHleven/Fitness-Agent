...
> **🚀 v0.5.30 最新更新**：Agent 的语义路由改为“模型理解、服务端授权”的严格分层，普通请求不再被关键词规则抢跑；历史意图字段不能扩大读取权限。全天饮食优化器也能安全采用超时前已找到且通过完整复验的可行方案，减少有效结果被误丢弃。
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <ul>
        ...
        <li>结合个人目标与当天训练生成可审阅的全天饮食方案，确认后再保存</li>
