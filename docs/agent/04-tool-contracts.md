...
说明：本文件记录 2026-08-19 的目标工具目录，不代表所有条目都已实现。截至 2026-08-22，真实运行时只开放 7 个认证用户只读工具；实现审计和 Tool Registry v2 静态契约见 [Tool Calling v2：现有工具审计与 Registry 契约](16-tool-calling-v2-registry.md)。
